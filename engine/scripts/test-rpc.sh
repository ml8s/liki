...
check_rpc "  has fu_yi.yong" '.result.data.fu_yi.yong != null' 'true'
check_rpc "  has tiao_hou" '.result.data.tiao_hou.primary_wuxing != null' 'true'
check_rpc "  has ge_ju" '.result.data.ge_ju.ge_ju != null' 'true'
