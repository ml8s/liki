...
func TestRPCInputRobustness(t *testing.T) {
	...
	valid := map[string]json.RawMessage{
		...
		"ziwei.liuyue":    mk(t, "chart", z, "target_lunar", map[string]any{"year": 2026, "month": 6, "day": 10, "leap": false}),
		"ziwei.liuri":     mk(t, "chart", z, "target_lunar", map[string]any{"year": 2026, "month": 6, "day": 4, "leap": false}),
		"ziwei.liushi":    mk(t, "chart", z, "target_lunar", map[string]any{"year": 2026, "month": 6, "day": 4, "leap": false}, "shi_zhi", "午"),
