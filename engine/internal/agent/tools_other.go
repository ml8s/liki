...
var otherMethods = []RPCMethod{
	...
	},
	{
		...
		Params:  mustSchema(`{"type":"object","properties":{"period_date":{"type":"string","format":"date","description":"宅运起盘日期，YYYY-MM-DD；年份 1864-2200"},"zuo_shan":{"type":"integer","minimum":0,"maximum":23,"description":"坐山"},"xiang_shan":{"type":"integer","minimum":0,"maximum":23,"description":"朝向；必须等于坐山后 12 山（180°相对）"}},"required":["period_date","zuo_shan","xiang_shan"]}`),
		Handler: xuankongChartHandler,
		Result:  envelopeSchema(`{"type":"object","properties":{"yun":{"type":"object","description":"三元九运","properties":{"year":{"type":"integer","description":"当前年份"},"yuan":{"type":"string","description":"上元/中元/下元"},"yun_number":{"type":"integer","description":"运数1-9"},"yun_name":{"type":"string","description":"运名:一运/九运"},"start_year":{"type":"integer","description":"本运起始年"}},"required":["year","yuan","yun_number"]},"gong_wei":{"type":"array"},"wang_shan":{"type":"boolean"},"chart_digest":{"type":"string","description":"canonical SHA-256 chart digest"},"zuo_shan":{"type":"integer","description":"坐山(0-23)"},"xiang_shan":{"type":"integer","description":"向山(0-23)"},"shan_xing":{"type":"boolean","description":"双星会坐：坐宫山向星皆当令"},"wang_xiang":{"type":"boolean","description":"旺向：向宫向星=当令"},"xiang_xing":{"type":"boolean","description":"双星会向：向宫山向星皆当令"},"xing_jia_hui":{"type":"array","description":"星加会"},"shou_shan_chu_sha":{"type":"object","description":"收山出煞"},"fu_yin":{"type":"boolean","description":"伏吟（运盘）"},"xia_shui":{"type":"boolean","description":"上山下水：向宫山星=当令且坐宫向星=当令"}},"required":["yun","gong_wei","wang_shan"]}`),
	},
	{
