...
const schemaFlyingStar = `{"type":"object","additionalProperties":false,"properties":{"number":{"type":"integer","minimum":1,"maximum":9},"color":{"type":"string","enum":["白","黑","碧","绿","黄","赤","紫"]},"name":{"type":"string","enum":["一白贪狼","二黑巨门","三碧禄存","四绿文曲","五黄廉贞","六白武曲","七赤破军","八白左辅","九紫右弼"]},"wuxing":{"type":"string","enum":["金","木","水","火","土"]},"auspicious":{"type":"boolean"}},"required":["number","color","name","wuxing","auspicious"]}`

const schemaAnnualFlyingStar = `{"type":"object","additionalProperties":false,"properties":{"gong_num":{"type":"integer","minimum":1,"maximum":9},"xing":{"type":"integer","minimum":1,"maximum":9},"xing_name":{"type":"string","enum":["一白贪狼","二黑巨门","三碧禄存","四绿文曲","五黄廉贞","六白武曲","七赤破军","八白左辅","九紫右弼"]},"wuxing":{"type":"string","enum":["金","木","水","火","土"]},"rating":{"type":"string","enum":["大吉","吉","平","凶","大凶"]},"ru_zhong":{"type":"boolean"}},"required":["gong_num","xing","xing_name","wuxing","rating","ru_zhong"]}`
...
const schemaXuankongChartData = `{"type":"object","description":"xuankong.chart 返回的完整宅盘；传回 xuankong.liunian 时 digest 必须匹配","additionalProperties":false,"properties":{"yun":{"type":"object","additionalProperties":false,"properties":{"year":{"type":"integer","minimum":1864,"maximum":2200},"yuan":{"type":"string","enum":["上元","中元","下元"]},"yun_number":{"type":"integer","minimum":1,"maximum":9},"yun_name":{"type":"string","enum":["一运","二运","三运","四运","五运","六运","七运","八运","九运"]},"start_year":{"type":"integer"},"end_year":{"type":"integer"}},"required":["year","yuan","yun_number","yun_name","start_year","end_year"]},"gong_wei":{"type":"array","minItems":9,"maxItems":9,"items":` + schemaXuankongPalace + `},"wang_shan":{"type":"boolean"},"wang_xiang":{"type":"boolean"},"shan_xing":{"type":"boolean","description":"双星会坐：坐宫山向星皆当令"},"xiang_xing":{"type":"boolean","description":"双星会向：向宫山向星皆当令"},"xia_shui":{"type":"boolean","description":"上山下水：向宫山星=当令且坐宫向星=当令"},"fu_yin":{"type":"boolean","description":"伏吟（运盘）"},"xing_jia_hui":{"type":"array","minItems":9,"maxItems":9,"description":"星加会","items":{"type":"object","additionalProperties":false,"properties":{"shan_num":{"type":"integer","minimum":1,"maximum":9},"xiang_num":{"type":"integer","minimum":1,"maximum":9},"name":{"type":"string"},"meaning":{"type":"string"},"classification":{"type":"string","enum":["auspicious","inauspicious","unlisted"],"description":"固定通则吉凶；unlisted 表示未列入通则，不是凶"}},"required":["shan_num","xiang_num","name","meaning","classification"]}},"chart_digest":{"type":"string","description":"canonical SHA-256 chart digest"},"zuo_shan":{"type":"integer","minimum":0,"maximum":23,"description":"坐山(0-23)"},"zuo_shan_name":{"type":"string"},"xiang_shan":{"type":"integer","minimum":0,"maximum":23,"description":"向山(0-23)"},"xiang_shan_name":{"type":"string"},"shou_shan_chu_sha":{"type":"object","additionalProperties":false,"properties":{"zheng_shen":{"type":"integer","minimum":1,"maximum":9},"ling_shen":{"type":"integer","minimum":1,"maximum":9},"shou_shan":{"type":"boolean"},"chu_sha":{"type":"boolean"},"assessment":{"type":"string"}},"required":["zheng_shen","ling_shen","shou_shan","chu_sha","assessment"]}},"required":["yun","gong_wei","wang_shan","wang_xiang","shan_xing","xiang_xing","xia_shui","fu_yin","xing_jia_hui","chart_digest","zuo_shan","zuo_shan_name","xiang_shan","xiang_shan_name","shou_shan_chu_sha"]}`
...
var otherMethods = []RPCMethod{
	...
	},
	{
		...
		Result:  envelopeSchema(`{"type":"object","additionalProperties":false,"properties":{"ming_gua":{"type":"object","additionalProperties":false,"properties":{"gua":{"type":"object","additionalProperties":false,"properties":{"index":{"type":"integer","minimum":1,"maximum":9},"name":{"type":"string","enum":["坎","坤","震","巽","乾","兑","艮","离"]},"wuxing":{"type":"string","enum":["水","土","木","金","火"]},"yin_yang":{"type":"string","enum":["阳","阴"]}},"required":["index","name","wuxing","yin_yang"]},"group":{"type":"string","enum":["东四命","西四命"]}},"required":["gua","group"]},"ba_zhai_dirs":{"type":"object","additionalProperties":false,"properties":{"sheng_qi":` + schemaDirectionArray + `,"tian_yi":` + schemaDirectionArray + `,"yan_nian":` + schemaDirectionArray + `,"fu_wei":` + schemaDirectionArray + `,"huo_hai":` + schemaDirectionArray + `,"wu_gui":` + schemaDirectionArray + `,"liu_sha":` + schemaDirectionArray + `,"jue_ming":` + schemaDirectionArray + `},"required":["sheng_qi","tian_yi","yan_nian","fu_wei","huo_hai","wu_gui","liu_sha","jue_ming"]},"liu_nian_xing":{"type":"object","additionalProperties":false,"properties":{"year":{"type":"integer","minimum":1900,"maximum":2100},"ru_zhong":{"type":"string"},"gong_wei":{"type":"array","minItems":9,"maxItems":9,"items":` + schemaAnnualFlyingStar + `}},"required":["year","ru_zhong","gong_wei"]}},"required":["ming_gua","ba_zhai_dirs","liu_nian_xing"]}`),
	},
	{
	...
	},
	{
		...
		Result:  envelopeSchema(`{"type":"object","additionalProperties":false,"properties":{"year":{"type":"integer","minimum":1864,"maximum":2200},"ru_zhong":{"type":"string","description":"入中星名"},"gong_wei":{"type":"array","minItems":9,"maxItems":9,"items":` + schemaAnnualFlyingStar + `},"house_overlay":{"type":"array","description":"流年凶星落宫对照宅盘该宫三星","items":{"type":"object","additionalProperties":false,"properties":{"gong_num":{"type":"integer","minimum":1,"maximum":9},"star":{"type":"string"},"star_rating":{"type":"string","enum":["凶","大凶"]},"palace_stars":{"type":"string","description":"运星/山星/向星"}},"required":["gong_num","star","star_rating","palace_stars"]}}},"required":["year","ru_zhong","gong_wei"]}`),
	},
