...
var ziweiMethods = []RPCMethod{
	{
		...
		Params: mustSchema(`{"type":"object","properties":{"lunar":{"type":"object","properties":{"year":{"type":"integer"},"month":{"type":"integer"},"day":{"type":"integer"},"leap":{"type":"boolean","description":"是否农历闰月"},"shichen":{"type":"string","enum":["子","丑","寅","卯","辰","巳","午","未","申","酉","戌","亥"],"description":"时辰（子丑寅卯辰巳午未申酉戌亥）"}},"required":["year","month","day","shichen"]},"gender":` + schemaGender + `},"required":["lunar","gender"]}`), Handler: ziweiChartHandler,
