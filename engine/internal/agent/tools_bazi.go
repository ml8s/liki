...
var baziMethods = []RPCMethod{
	...
	},
	{
		...
		Result:  envelopeSchema(`{"type":"object","properties":{"year":{"type":"integer"},"nian_name":{"type":"string"},"shi_shen":{"type":"string","enum":["正官","偏官","正印","偏印","正财","偏财","比肩","劫财","食神","伤官"]},"nian_gan":{"type":"string","description":"流年天干"},"nian_zhi":{"type":"string","description":"流年地支"},"wuxing":{"type":"string"},"na_yin":{"type":"string"},"sheng":{"type":"integer","description":"生数"},"ke":{"type":"integer","description":"克数"},"shensha":{"type":"array","description":"流年神煞（动态：桃花/驿马/华盖/劫煞/灾煞/红鸾/天喜/天乙贵人/羊刃——年支+日支双查；值年：病符/丧门/吊客/大耗——命局四柱逢煞支即应）","items":{"type":"object","properties":{"name":{"type":"string","enum":["桃花","驿马","华盖","劫煞","灾煞","红鸾","天喜","天乙贵人","羊刃","病符","丧门","吊客","大耗"]},"category":{"type":"string","enum":["吉","凶","中性"]},"description":{"type":"string"}}}},"fuyin_fanyin":{"type":"array","description":"伏吟反吟"},"dayun_interactions":{"type":"array","description":"查询年份所在大运与流年交互（chart 需含 birth_year；未起运/大运过完/缺 birth_year 时为空数组）"},"natal_interactions":{"type":"array","description":"流年与命局交互"}},"required":["year","nian_name","shi_shen"]}`),
	},
	{
		...
		Result:  envelopeSchema(`{"type":"object","properties":{"year":{"type":"integer"},"month":{"type":"integer"},"month_name":{"type":"string"},"shi_shen":{"type":"string","enum":["正官","偏官","正印","偏印","正财","偏财","比肩","劫财","食神","伤官"]},"yue_gan":{"type":"string","description":"流月天干"},"yue_zhi":{"type":"string","description":"流月地支"},"wuxing":{"type":"string"},"sheng":{"type":"integer"},"ke":{"type":"integer"},"shensha":{"type":"array","description":"流月神煞（动态：桃花/驿马/华盖/劫煞/灾煞/红鸾/天喜/天乙贵人/羊刃——年支+日支双查）","items":{"type":"object","properties":{"name":{"type":"string","enum":["桃花","驿马","华盖","劫煞","灾煞","红鸾","天喜","天乙贵人","羊刃"]},"category":{"type":"string","enum":["吉","凶","中性"]},"description":{"type":"string"}}}},"gan_rels":{"type":"array","description":"天干关系"},"zhi_rels":{"type":"array","description":"地支关系"}},"required":["year","month","month_name","shi_shen"]}`),
	},
	{
