...
func TestAllMethodsSchema(t *testing.T) {
	...
	calls := map[string]json.RawMessage{
		...
		"ziwei.liuyue":     mk(map[string]any{"chart": z, "lunar_year": 2026, "lunar_month": 6}),
		"ziwei.liuri":      mk(map[string]any{"chart": z, "lunar_year": 2026, "lunar_month": 6, "lunar_day": 4}),
		"ziwei.liushi":     mk(map[string]any{"chart": z, "lunar_year": 2026, "lunar_month": 6, "lunar_day": 4, "shi_zhi": "午"}),
