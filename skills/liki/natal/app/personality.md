...
| 步骤 | 条件 / 目标 | 动作 | 产物 |
| --- | --- | --- | --- |
| 1 | 基础性格 | 分别发送 `TOOLS.md §2` 的 `analyze_natal`、`analyze_natal`；读取 `natal/domains/bazi/wangshuai.md` | 日主、身强弱、基础特征 |
| 2 | 组合修正 | 发送 `TOOLS.md §2 analyze_natal`；读取 `natal/domains/bazi/shishen.md` | 十神组合与修正方向 |
