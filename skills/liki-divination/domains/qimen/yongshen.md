...
`qimen.chart` 引擎输出以下确定性因子，断局时应综合参考：
...
| 克应 | `gan_interaction`（戊加丙=飞鸟跌穴等）| 天盘+地盘克应的吉凶 |
| 应期 | `ying_qi` | 见 `yingqi.md` |

## 📖 解读原则（LLM）

- **用神落宫以天盘为核心判断依据**：日干/时干/用神干落宫均取天盘位置（天盘主求测人/所问事之当下状态，地盘反映过去/潜藏）
