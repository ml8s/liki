...
os.environ.setdefault("LIKI_JUDGMENT_DOMAIN", "bazi")

import pytest  # noqa: E402

from app.judgment_server import create_judgment_server  # noqa: E402
...
def test_judgment_server_tools():
    srv = create_judgment_server("bazi")
