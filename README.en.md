...
- Judgments come from 734 truth-table rules, each citing classical sources (Ziping Zhenquan, Dih Tian Sui, etc.)
...
- **Sourced judgments** — 41 truth tables with 734 rules, each with a classical-citation column.
