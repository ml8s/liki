...
- Judgments come from 722 truth-table rules, each citing classical sources (Ziping Zhenquan, Dih Tian Sui, etc.)
...
- **Sourced judgments** — 41 truth tables with 722 rules, each with a classical-citation column.
