...
- Judgments come from 755 truth-table rules, each citing classical sources (Ziping Zhenquan, Dih Tian Sui, etc.)
...
- **Sourced judgments** — 41 truth tables with 755 rules, each with a classical-citation column.
