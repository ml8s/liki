...
| `bazi_relation_groups.json` | 天干五合（邻柱口径）、地支六合、三合 / 三会 / 六冲 / 六害 / 三刑完整组与自刑成双边界 |
| `bazi_liunian_atomic.json` | 流年生克、忌神、财坏印、三合 / 三会 / 三刑 / 半合原子事实 |
| `ziwei_core.json` | 四化 10、命主 12、身主 12、闰月边界 3 |
...
| `qimen_core.json` | 二十四节气 × 三元 72 局 |
| `qimen_specialized.json` | 庚格四柱遁甲、失物时干宫、盗贼天蓬 / 玄武、天网五行关系 |
| `huangli_core.json` | 建除 12、十二月青龙起例 12、事项规则 10、日期锚点 |
| `fengshui_core.json` | 二十四山 24、八宅大游年 8、命卦锚点、流年飞星、三元九运、玄空四大局 |
