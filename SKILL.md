...
**Gate 强制清单（按题型必填，未填完禁止给结论）**：

| 题型 | 必须先填的检查表（app 卡对应步骤）|
|------|--------------------------------|
| 学业/学历 | 印星三关（得令/不被财克/有根）→ 学历定档表（app/study.md 第1-3步）|
| 性格/外貌 | 身强弱前置判定 → 十神取象（app/personality.md）|
| 婚姻/感情 | 官杀（女）/财星（男）状态 + 大运窗口 + 紫微夫妻宫交叉（app/marriage.md 第4步强制）|
| 事业/职业 | 官杀定层次 × 财星定类型 × 食伤定方向（app/career.md）|
| 财运 | 财星强弱 × 身强弱任财 × 大运生扶（app/wealth.md）|
| 健康/灾劫/官非 | 忌神攻身年 + 五行脏腑 + 大运×流年精确应期（app/health.md + dayun.md）|
| 应期（何年发生）| 大运窗口 × 流年引动（双重/三重）取交集 → 具体年份（dayun.md）|
| 家庭/六亲 | 年柱（出身）+ 十神对应（偏财父/印母/官配偶）+ 大运引动（app/family.md）|
| 子女 | 食伤星 + 时柱 + 流年引动（app/family.md）|
