...
| domains/bazi/gongwei.md | 宫位论（年/月/日/时四柱） | 《渊海子平》 |
| domains/bazi/liuqin.md | 六亲判断（父母配偶子女） | 《渊海子平》 |
| domains/bazi/wuxing-jiankang.md | 五行健康对应 | 《黄帝内经》 |
| domains/bazi/caiyun.md | 财运判断 | 《滴天髓》 |
| domains/bazi/xueye.md | 学历判断 | 《渊海子平》 |
| domains/bazi/shiye.md | 事业判断 | 《子平真诠》 |
| domains/bazi/hepan.md | 合盘评估（致命排除→匹配→可持续性→评级） | 《三命通会》 |
...
4. **考时确认**：按 `domains/bazi/calibration.md` 执行时辰校准。
   - 八字硬排除后仍有 ≥ 2 盘 → 📖搜索 `domains/ziwei/calibration.md` → 紫微交叉验证
   - 确认时辰后继续。宝宝/青少年跳过此步。
...
完成后产出的结构化数据 → `app/fatechart.md` 继续命盘分析输出。