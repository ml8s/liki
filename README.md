...
<p align="center">
  <strong>面向 Claude Code 的中国传统命理 AI 技能包</strong>
</p>
...
- **版本管理** — 每个技能启动时自动检查更新，持续迭代
- **注重隐私** — 不在对话外存储出生信息，纯会话内计算
- **开箱即用** — 一条命令安装，直接在 Claude Code 中调用
...
所有技能共享同一套 JSON-RPC 2.0 命理引擎，按领域分组：
