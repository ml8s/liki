...
**Liki** 是命理师的 Skill，覆盖八字、紫微、起名、六爻、奇门、择日、风水。`npx skills add ml8s/liki` 装完即用，在 AI 助手中直接使用。

基于天文历算 API + 双体系交叉验证，所有排盘、用神、大运等数据由引擎计算，不靠 AI 臆测。

覆盖 **8 个独立领域**，内置 **9 份方法论文档**，报告流程经 **generate → review → revise** 三阶段审查。
