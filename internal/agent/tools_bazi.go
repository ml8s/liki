...
var baziMethods = []RPCMethod{
	...
	},
	{
		...
		Result:  envelopeSchema(`{"type":"object","properties":{"year":{"type":"integer"},"month":{"type":"integer"},"month_name":{"type":"string"},"shi_shen":{"type":"string","enum":["正官","偏官","正印","偏印","正财","偏财","比肩","劫财","食神","伤官"]},"yue_gan":{"type":"string","description":"流月天干"},"yue_zhi":{"type":"string","description":"流月地支"},"wuxing":{"type":"string"},"generates":{"type":"integer"},"restrains":{"type":"integer"},"shensha":{"type":"array","description":"流月神煞"},"gan_rels":{"type":"array","description":"天干关系"},"zhi_rels":{"type":"array","description":"地支关系"}},"required":["year","month","month_name","shi_shen"]}`),
	},
	{
