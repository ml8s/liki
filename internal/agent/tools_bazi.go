...
var baziMethods = []RPCMethod{
	{
		...
		Result: envelopeSchema(`{"type":"object","properties":{"nian":{"type":"object","properties":{"gan":{"type":"string","enum":["甲","乙","丙","丁","戊","己","庚","辛","壬","癸"]},"zhi":{"type":"string","enum":["子","丑","寅","卯","辰","巳","午","未","申","酉","戌","亥"]},"na_yin":{"type":"string"}},"required":["gan","zhi","na_yin"]},"yue":{"type":"object","properties":{"gan":{"type":"string","enum":["甲","乙","丙","丁","戊","己","庚","辛","壬","癸"]},"zhi":{"type":"string","enum":["子","丑","寅","卯","辰","巳","午","未","申","酉","戌","亥"]},"na_yin":{"type":"string"}},"required":["gan","zhi","na_yin"]},"ri":{"type":"object","properties":{"gan":{"type":"string","enum":["甲","乙","丙","丁","戊","己","庚","辛","壬","癸"]},"zhi":{"type":"string","enum":["子","丑","寅","卯","辰","巳","午","未","申","酉","戌","亥"]},"na_yin":{"type":"string"}},"required":["gan","zhi","na_yin"]},"shi":{"type":"object","properties":{"gan":{"type":"string","enum":["甲","乙","丙","丁","戊","己","庚","辛","壬","癸"]},"zhi":{"type":"string","enum":["子","丑","寅","卯","辰","巳","午","未","申","酉","戌","亥"]},"na_yin":{"type":"string"}},"required":["gan","zhi","na_yin"]},"da_yun":{"type":"object","description":"大运。start_year_after/start_month_after/start_day_after 为出生后起运精确时间；direction 顺排/逆排；steps 每步含 gan/zhi/qi_sui/age_end/name/element/shi_shen（十年一运）；current_step_index 当前大运索引"},"gender":{"type":"string"},"san_yuan":{"type":"object","description":"三元: 胎元/命宫/身宫"},"gong_jia":{"type":"array","description":"拱夹"},"nayin_rel":{"type":"array","description":"纳音生克"},"chang_sheng":{"type":"array","description":"长生十二宫"},"san_qi_name":{"type":"string","description":"三奇贵人"},"gan_he":{"type":"array","description":"天干五合"},"zhi_liu_he":{"type":"array","description":"地支六合"},"san_he":{"type":"array","description":"三合局"},"san_hui":{"type":"array","description":"三会方"},"liu_chong":{"type":"array","description":"六冲"},"liu_hai":{"type":"array","description":"六害"},"liu_xing":{"type":"array","description":"相刑"}},"required":["nian","yue","ri","shi","da_yun","gender"]}`),
	},
	{
		...
		Result: envelopeSchema(`{"type":"object","properties":{"nian":{"type":"object","properties":{"gan":{"type":"string","enum":["甲","乙","丙","丁","戊","己","庚","辛","壬","癸"]},"zhi":{"type":"string","enum":["子","丑","寅","卯","辰","巳","午","未","申","酉","戌","亥"]},"na_yin":{"type":"string"}},"required":["gan","zhi","na_yin"]},"yue":{"type":"object","properties":{"gan":{"type":"string","enum":["甲","乙","丙","丁","戊","己","庚","辛","壬","癸"]},"zhi":{"type":"string","enum":["子","丑","寅","卯","辰","巳","午","未","申","酉","戌","亥"]},"na_yin":{"type":"string"}},"required":["gan","zhi","na_yin"]},"ri":{"type":"object","properties":{"gan":{"type":"string","enum":["甲","乙","丙","丁","戊","己","庚","辛","壬","癸"]},"zhi":{"type":"string","enum":["子","丑","寅","卯","辰","巳","午","未","申","酉","戌","亥"]},"na_yin":{"type":"string"}},"required":["gan","zhi","na_yin"]},"shi":{"type":"object","properties":{"gan":{"type":"string","enum":["甲","乙","丙","丁","戊","己","庚","辛","壬","癸"]},"zhi":{"type":"string","enum":["子","丑","寅","卯","辰","巳","午","未","申","酉","戌","亥"]},"na_yin":{"type":"string"}},"required":["gan","zhi","na_yin"]},"da_yun":{"type":"object","description":"大运。start_year_after/start_month_after/start_day_after 为出生后起运精确时间（3天=1年）；direction 顺排/逆排；steps 每步含 gan/zhi/qi_sui/age_end/name/element/shi_shen（十年一运）；current_step_index 为当前所处大运索引（-1 表示未起运或已过完所有大运）"},"gender":{"type":"string"}},"required":["nian","yue","ri","shi","da_yun","gender"]}`),
	},
	{
	...
	},
	{
		...
		Result:  envelopeSchema(`{"type":"object","properties":{"zhu_cross":{"type":"object","description":"16对四柱互配结果，含jia_zhu/yi_zhu/jia_gan/yi_gan/gan_guan_xi/zhi_guan_xi等"},"shi_shen_cross":{"type":"object","description":"双方日主看对方四柱的十神映射: jia_dui_yi/yi_dui_jia"},"structure":{"type":"object","description":"大运交叉+旬宫判断，含da_yun/xun_gong"}},"required":["zhu_cross","shi_shen_cross","structure"]}`),
	},
	{
		...
		Result:  envelopeSchema(`{"type":"object","properties":{"year":{"type":"integer"},"year_name":{"type":"string"},"shi_shen":{"type":"string","enum":["正官","偏官","正印","偏印","正财","偏财","比肩","劫财","食神","伤官"]}},"year_stem":{"type":"string","description":"流年天干"},"year_branch":{"type":"string","description":"流年地支"},"wuxing":{"type":"string"},"nayin":{"type":"string"},"generates":{"type":"integer","description":"生数"},"restrains":{"type":"integer","description":"克数"},"shensha":{"type":"array","description":"流年神煞"},"fuyin_fanyin":{"type":"array","description":"伏吟反吟"},"dayun_interactions":{"type":"array","description":"大运流年交互"},"natal_interactions":{"type":"array","description":"流年与命局交互"},"required":["year","year_name","shi_shen"]}`),
	},
	{
		...
		Result:  envelopeSchema(`{"type":"object","properties":{"year":{"type":"integer"},"month":{"type":"integer"},"month_name":{"type":"string"},"shi_shen":{"type":"string","enum":["正官","偏官","正印","偏印","正财","偏财","比肩","劫财","食神","伤官"]}},"month_stem":{"type":"string","description":"流月天干"},"month_branch":{"type":"string","description":"流月地支"},"wuxing":{"type":"string"},"generates":{"type":"integer"},"restrains":{"type":"integer"},"shensha":{"type":"array","description":"流月神煞"},"gan_rels":{"type":"array","description":"天干关系"},"zhi_rels":{"type":"array","description":"地支关系"},"required":["year","month","month_name","shi_shen"]}`),
	},
	{
	...
	},
	{
		...
		Result:  envelopeSchema(`{"type":"object","properties":{"time":{"type":"string"},"hour_name":{"type":"string"},"shi_shen":{"type":"string","enum":["正官","偏官","正印","偏印","正财","偏财","比肩","劫财","食神","伤官"]}},"hour_stem":{"type":"string","description":"流时天干"},"hour_branch":{"type":"string","description":"流时地支"},"gan_rels":{"type":"array","description":"天干关系"},"zhi_rels":{"type":"array","description":"地支关系"},"required":["time","hour_name","shi_shen"]}`),
	},
	{
