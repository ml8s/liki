...
var baziMethods = []RPCMethod{
	...
	},
	{
		...
		Result:  envelopeSchema(`{"type":"object","properties":{"year":{"type":"integer"},"nian_name":{"type":"string"},"shi_shen":{"type":"string","enum":["正官","偏官","正印","偏印","正财","偏财","比肩","劫财","食神","伤官"]},"nian_gan":{"type":"string","description":"流年天干"},"nian_zhi":{"type":"string","description":"流年地支"},"wuxing":{"type":"string"},"na_yin":{"type":"string"},"sheng":{"type":"integer","description":"生数"},"ke":{"type":"integer","description":"克数"},"shensha":{"type":"array","description":"流年神煞"},"fuyin_fanyin":{"type":"array","description":"伏吟反吟"},"dayun_interactions":{"type":"array","description":"大运流年交互"},"natal_interactions":{"type":"array","description":"流年与命局交互"}},"required":["year","nian_name","shi_shen"]}`),
	},
	{
