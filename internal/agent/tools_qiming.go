...
var qimingMethods = []RPCMethod{
	...
	},
	{
		...
		Result: envelopeSchema(`{"type":"array","items":{"type":"object","properties":{"name":{"type":"string"},"surname":{"type":"string"},"given_name":{"type":"string"},"characters":{"type":"array"},"wuge":{"type":"object","description":"五格配置","properties":{"tiange":{"type":"object","description":"天格"},"renge":{"type":"object","description":"人格"},"dige":{"type":"object","description":"地格"},"waige":{"type":"object","description":"外格"},"zongge":{"type":"object","description":"总格"}}},"sancai":{"type":"object","description":"三才配置","properties":{"configuration":{"type":"string","description":"三才组合（如木火土）"},"fortune":{"type":"string","description":"三才吉凶","enum":["大吉","吉","半吉","凶"]},"description":{"type":"string","description":"三才解释"}},"required":["configuration","fortune"]},"phonetic":{"type":"object","properties":{"tones":{"type":"string"}},"required":["tones"]},"wuxing_match":{"type":"boolean"},"wuxing":{"type":"object","properties":{"yong":{"type":"boolean"},"xi":{"type":"boolean"},"ji":{"type":"boolean"}},"required":["yong"]}},"required":["name","surname","given_name","wuge","sancai","phonetic","wuxing_match"]}}`),
	},
	{
