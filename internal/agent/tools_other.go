...
var otherMethods = []RPCMethod{	{
		...
		Result:  envelopeSchema(`{"type":"object","properties":{"pan":{"type":"object","description":"奇门排盘结果","properties":{"jushu":{"type":"integer","description":"局数"},"yin_dun":{"type":"boolean","description":"阴遁/阳遁"},"ri_gan":{"type":"string","description":"日干"},"ri_zhi":{"type":"string","description":"日支"},"drive_gan":{"type":"string","description":"时干"},"drive_zhi":{"type":"string","description":"时支"},"duty_star":{"type":"integer","description":"值符星序号"},"duty_door":{"type":"integer","description":"值使门序号"},"palaces":{"type":"array","description":"九宫排盘结果"},"ma_xing":{"type":"integer","description":"马星宫位"},"kong_wang":{"type":"array","description":"空亡地支"}},"required":["jushu","yin_dun","ri_gan","ri_zhi"]},"patterns":{"type":"array"}},"required":["pan","patterns"]}`),
	},
	{
	...
	},
	{
		...
		Result:  envelopeSchema(`{"type":"object","properties":{"yong_shen":{"type":"object","properties":{"name":{"type":"string"},"position":{"type":"integer"},"month":{"type":"string"},"day":{"type":"string"},"day_power":{"type":"string"},"is_dong":{"type":"boolean"}},"required":["name","position","month","day"]},"rating":{"type":"string"},"advice":{"type":"string"}},"required":["yong_shen","rating","advice"]}`),
	},
	{
	...
	},
	{
		...
		Result:  envelopeSchema(`{"type":"object","properties":{"name":{"type":"string"},"ben_gua":{"type":"integer"},"lines":{"type":"array"},"yong_shen":{"type":"object","description":"用神状态","properties":{"name":{"type":"string","description":"用神六亲"},"position":{"type":"integer","description":"爻位1-6"},"month":{"type":"string","description":"月令旺衰:旺/相/休/囚/死"},"day":{"type":"string","description":"日建关系:生/扶/克/冲/合/平"},"day_power":{"type":"string","description":"日建力:旺/平/衰"},"is_dong":{"type":"boolean","description":"是否为动爻"},"is_yue_po":{"type":"boolean","description":"月破"},"is_chi_shi":{"type":"boolean","description":"持世"},"dong_sheng":{"type":"boolean","description":"动爻生用神"},"dong_ke":{"type":"boolean","description":"动爻克用神"}}},"wang_shuai":{"type":"array"},"month_zhi":{"type":"string"},"month_gan":{"type":"string"},"ying_qi":{"type":"object","description":"应期判断结果","properties":{"yong_shen":{"type":"string","description":"用神"},"dong_yao_pos":{"type":"integer","description":"动爻位置"},"ying_time":{"type":"string","description":"应期描述"},"assessment":{"type":"string","description":"综合判断"}},"required":["yong_shen","assessment"]}},"required":["name","ben_gua","lines","yong_shen"]}`),
	},
	{
		...
		Result:  envelopeSchema(`{"type":"object","properties":{"date":{"type":"string"},"day_pillar":{"type":"object","properties":{"gan":{"type":"string"},"zhi":{"type":"string"},"nayin":{"type":"string"}},"required":["gan","zhi"]},"nayin":{"type":"string"},"wuxing":{"type":"string"},"jian_chu":{"type":"string"},"suitable":{"type":"boolean"},"marks":{"type":["array","null"],"items":{"type":"string"}},"warnings":{"type":["array","null"],"items":{"type":"string"}},"huangdao":{"type":"object","properties":{"name":{"type":"string"},"path":{"type":"string"}},"required":["name","path"]},"xi_shen":{"type":"string"},"cai_shen":{"type":"string"},"fu_shen":{"type":"string"},"stem_taboo":{"type":"string"},"branch_taboo":{"type":"string"},"mansion":{"type":"object","properties":{"name":{"type":"string"},"index":{"type":"integer"}},"required":["name","index"]}},"required":["date","day_pillar","suitable"]}`),
	},
	{
		...
		Result:  envelopeSchema(`{"type":"object","properties":{"month":{"type":"string"},"days":{"type":"array","items":{"type":"object","properties":{"date":{"type":"string"},"day_pillar":{"type":"object","properties":{"gan":{"type":"string"},"zhi":{"type":"string"},"nayin":{"type":"string"}},"required":["gan","zhi"]},"nayin":{"type":"string"},"wuxing":{"type":"string"},"jian_chu":{"type":"string"},"suitable":{"type":"boolean"},"marks":{"type":["array","null"],"items":{"type":"string"}},"warnings":{"type":["array","null"],"items":{"type":"string"}},"huangdao":{"type":"object","properties":{"name":{"type":"string"},"path":{"type":"string"}},"required":["name","path"]},"xi_shen":{"type":"string"},"cai_shen":{"type":"string"},"fu_shen":{"type":"string"},"stem_taboo":{"type":"string"},"branch_taboo":{"type":"string"},"mansion":{"type":"object","properties":{"name":{"type":"string"},"index":{"type":"integer"}},"required":["name","index"]}},"required":["date","day_pillar","suitable"]}}},"required":["month","days"]}`),
	},
	{
...
"date":{"type":"string"},
"day_pillar":{"type":"object","properties":{"gan":{"type":"string"},"zhi":{"type":"string"},"na_yin":{"type":"string"}},"required":["gan","zhi","na_yin"]},
"nayin":{"type":"string"},
"wuxing":{"type":"string"},
"jian_chu":{"type":"string"},
...
"mansion":{"type":"object","properties":{"index":{"type":"integer"},"name":{"type":"string"},"animal":{"type":"string"},"wuxing":{"type":"string"},"group":{"type":"string"}},"required":["name","index"]},
"jie_qi":{"type":"string"},
