...
var ziweiMethods = []RPCMethod{
	...
	},
	{
		...
		Result:  envelopeSchema(`{"type":"object","properties":{"ming_gong":{"type":"string","enum":["命宫","兄弟","夫妻","子女","财帛","疾厄","迁移","仆役","官禄","田宅","福德","父母"]},"ming_gong_name":{"type":"string"},"zhi":{"type":"string","description":"流年地支","enum":["子","丑","寅","卯","辰","巳","午","未","申","酉","戌","亥"]},"si_hua":{"type":"object"},"si_hua_palace":{"type":"object"},"fu_xing":{"type":"object","description":"流年辅星"},"gong_wei":{"type":"array","description":"流年十二宫盘","items":{"type":"object","properties":{"zhi":{"type":"string","description":"地支"},"name":{"type":"string","description":"宫名"},"xing_yao":{"type":"array","description":"流耀"},"is_liu_ming":{"type":"boolean"}},"required":["zhi","name"]}}},"required":["ming_gong","zhi","si_hua"]}`),
	},
	{
